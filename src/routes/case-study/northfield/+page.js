...
export async function load({ fetch }) {
    const contentFile = await fetch('/web-assets/case-study/northfield/northfield-content.csv');
    ...
    const menuFile = await fetch('/web-assets/case-study/northfield/northfield-menuitems.csv');

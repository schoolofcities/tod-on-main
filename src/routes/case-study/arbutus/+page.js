...
export async function load({ fetch }) {
    const contentFile = await fetch('/web-assets/case-study/arbutus/arbutus-content.csv');
    ...
    const menuFile = await fetch('/web-assets/case-study/arbutus/arbutus-menuitems.csv');

...
export async function load({ fetch }) {
    const contentFile = await fetch('/web-assets/case-study/mckernan-belgravia/mckernan-content.csv');
    ...
    const menuFile = await fetch('/web-assets/case-study/mckernan-belgravia/mckernan-menuitems.csv');

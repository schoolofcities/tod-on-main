...
<main>
	...
	<div class="text">
		...
		<p>
			The team at the Housing Justice Lab has been tracking how new and planned rapid transit investments are reshaping neighbourhoods in five Canadian station areas. We are asking a simple but enduring question: when cities build transit, what are the effects on the ground – and for whom? 
		</p>
	</div>
